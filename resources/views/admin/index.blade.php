...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) { 
            ...
            .sidebar.show { transform: translateX(0); } /* Show when active */
            
            .main-content { margin-left: 0; padding: 1.5rem; }
            
            .sidebar-overlay.show { display: block; } /* Show overlay when active */
            
            .event-img { width: 60px; height: 40px; }
        }
    </style>
</head>
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex align-items-center mb-4 d-md-none">
            ...
            <h4 class="fw-bold mb-0">Events Manager</h4>
        </div>
                ...
                <table class="table table-hover mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th>Event Details</th>
                            <th class="d-none d-md-table-cell">Schedule</th> <!-- Hide on super small screens if needed -->
                            <th>Stats</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.events.registrants', $event->id) }}" class="btn btn-sm btn-outline-info mb-1 mb-md-0" title="View Registrants">
                                    <i class="fa-solid fa-users"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-outline-warning mb-1 mb-md-0" data-bs-toggle="modal" data-bs-target="#editEventModal{{ $event->id }}" title="Edit">
                                ...
                                <form action="{{ route('admin.events.destroy', $event->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this event?');">
                                    @csrf @method('DELETE')
                                    <button class="btn btn-sm btn-outline-danger mb-1 mb-md-0" title="Delete"><i class="fa-solid fa-trash"></i></button>
                                </form>
                            </td>
                        </tr>
