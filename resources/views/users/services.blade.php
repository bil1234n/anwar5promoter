...
<body>
    <div class="banner-title-area service-page">
        ...
        <div class="sub-banner-content-flex service-banner" style="opacity: 1;">
            <h1 class="banner-text">Services</h1>
        </div>
        ...
        <div class="container w-container">
            <div data-w-id="a12d2fd6-7583-d887-bf84-3a054e05e56b" style="opacity: 0;"
                ...
                <div class="title-width service-page">
                    ...
                    <h2 class="section-title white">High-impact services to take your business to the next level</h2>
                </div>
            </div>
                ...
                <div class="w-layout-grid service-grid">
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e58b-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            ...
                            <p class="white-content">
                                Facilitating the marketing, promotion, and sale of businesses and products compliant with Islamic dietary and ethical standards.
                            </p>
                        </div>
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e57d-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            ...
                            <p class="white-content">
                                Planning and executing various events while utilizing digital channels for promotion, reach, and engagement.
                            </p>
                        </div>
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e599-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            ...
                            <p class="white-content">
                                Builds interactive website and software applications ensuring a functional, cross-device online presence. 
                            </p>
                        </div>
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e5b5-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            ...
                            <p class="white-content">
                                Arranging tours and managing galleries, likely with a specific cultural, historical, or religious focus related to the Anwar 5 brand.
                            </p>
                        </div>
