...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="md:flex md:items-center md:justify-between mb-8 border-b border-slate-200 pb-6">
        ...
        <div class="mt-4 md:mt-0 flex items-center space-x-4">
            ...
            <!-- New Message Action -->
            <a href="{{ url('home') }}" class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all">
                🏠
                Home
            </a>
