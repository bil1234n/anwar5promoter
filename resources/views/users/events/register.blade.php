...
<head>
    ...
    <meta
        ...
        name="description">
    <meta content="Anwar5promoter Register HTML website template" property="og:title">
    <meta
        content="A brief explanation about the particular digital marketing service with the images and the growth points are listed with readable quality."
        property="og:description">
    <meta content="Anwar5promoter Register HTML website template" property="twitter:title">
    <meta
        content="A brief explanation about the particular digital marketing service with the images and the growth points are listed with readable quality."
    ...
    <style>
        /* 1. Variables (Consistent with previous pages) */
        :root {
        ...
        .register-card {
            ...
            width: 100%;
            max-width: 600px; /* Slightly wider than donation card for 2 columns */
    ...
    <div class="register-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('events.store', $event->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Other Info -->
                <div class="form-group">
                    <label for="other_information">Other Information <small style="font-weight: normal; color: #888;">(Optional)</small></label>
                    <textarea id="other_information" name="other_information" rows="3">{{ old('other_information') }}</textarea>
                </div>

                <!-- Actions -->
                <div class="action-buttons">
                    <button type="submit" class="btn btn-submit">Confirm Registration</button>
                    <a href="{{ route('event.index') }}" class="btn btn-cancel">Cancel</a>
                </div>
            </form>
        </div>
