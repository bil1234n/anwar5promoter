...
<head>
    ...
    <meta
        ...
        name="description">
    <meta content="My Event" property="og:title">
    <meta
        content="A brief explanation about the particular digital marketing service with the images and the growth points are listed with readable quality."
        property="og:description">
    <meta content="My Event" property="twitter:title">
    <meta
        content="A brief explanation about the particular digital marketing service with the images and the growth points are listed with readable quality."
            ...
            <div class="container w-container">
                ...
                <div class="cont_2">
                    ...
                    <div class="page-header">
                        ...
                        <a href="{{ route('event.index') }}" class="btn-primary">Browse More Events</a>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="custom-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="event-title">{{ $reg->event->title }}</span>
                                            </td>
                                            <td>
                                                <span class="date-text">
                                                    {{ \Carbon\Carbon::parse($reg->event->event_date)->format('M d, Y • h:i A') }}
                                                </span>
                                            </td>
                                            <td>
                                                <span class="date-text">
