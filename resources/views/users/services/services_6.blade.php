                ...
                <div class="w-layout-grid service-grid">
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e599-68652b7b"
                        ...
                        <div class="card-image-wrap"><img
                                ...
                                loading="lazy" width="76" alt="Home Page Card Image For Title"></div>
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Educational and Skill Development Programs</h3>
                            <p class="white-content">
                                For the orphaned children, a key service is providing access to formal education (school enrollment support) and running extracurricular tutoring or vocational skill training. For the elderly, this might include literacy programs or activities that encourage cognitive engagement and social interaction.
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e5a7-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Advocacy and Community Awareness</h3>
                            <p class="white-content">
                                The foundation engages in advocacy work to raise awareness within the community and with local authorities about the specific challenges and rights of the elderly and orphans. This service aims to mobilize community support, donations, and volunteerism to improve policies and increase resource allocation for these vulnerable groups.
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
