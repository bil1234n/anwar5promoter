...
<body>
    <div class="banner-title-area service-page">
        ...
        <div class="sub-banner-content-flex service-banner" style="display: block; opacity: 1;">
            <h1 class="banner-text">Services 2</h1>
            <h2>Events organizing & Digital Marketing</h2>
        </div>
...
" class="sub-banner-decorative-two">
    ...
    <div class="service-section service-page">
        <div class="container w-container">
            <div data-w-id="a12d2fd6-7583-d887-bf84-3a054e05e56b" style="opacity: 0;"
                ...
                <div class="title-width service-page">
                    <div class="section-sub-title center-align">
                        <p class="sub-title-content grey"><span class="sub-title-slash">//</span> 02 . Services</p>
                    </div>
                    <h2 class="section-title white">Events organizing & Digital Marketing</h2>
                </div>
            </div>
                ...
                <div class="w-layout-grid service-grid">
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e57d-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Integrated Event Marketing Campaign Management</h3>
                            <p class="white-content">
                                This service handles the entire digital promotional strategy for an event, from pre-event buzz to post-event follow-up. It involves creating a cohesive, multi-channel strategy that includes targeted paid advertising (PPC/Social Ads), influencer outreach, press releases, and creating the visual assets (videos, graphics) needed to drive ticket sales or registrations. The goal is a seamless attendee journey from seeing the first ad to arriving at the venue (or virtual platform).
                            </p>
                        </div>
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e58b-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Event-Specific Landing Page & CRM Integration</h3>
                            <p class="white-content">
                                This is the technical backbone of event promotion. It involves designing and optimizing a dedicated high-conversion landing page or event website (Registration/Ticketing) that is fast, mobile-friendly, and captures visitor data efficiently. Crucially, this service includes integrating the page with a CRM (Customer Relationship Management) system to automatically manage, segment, and nurture leads with personalized email marketing sequences (e.g., "Save the Date," "Agenda Reminder," "Post-Event Thank You & Survey").
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e599-68652b7b"
                        ...
                        <div class="card-image-wrap"><img
                                ...
                                loading="lazy" width="76" alt="Home Page Card Image For Title"></div>
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Digital Content & Live-Streaming Production</h3>
                            <p class="white-content">
                                This service manages the creation and dissemination of high-quality media designed to capture the event's experience. This includes professional live-streaming for hybrid or virtual events, creating short-form video highlight reels and behind-the-scenes (BTS) content for social media (e.g., Instagram Reels, TikTok), and capturing professional photography and testimonial videos for future marketing materials. This content is used to extend the event's reach and prove its value.
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e5a7-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Post-Event Data Analysis & ROI Reporting</h3>
                            <p class="white-content">
                                This service focuses on measuring the success of the event and its digital marketing efforts. It involves collecting and analyzing data from the registration platform, website analytics (Google Analytics), paid ad dashboards, and post-event surveys. The result is a detailed report on key metrics like Cost Per Attendee (CPA), engagement rates, lead quality, and the overall Return on Investment (ROI), providing actionable insights for improving future events.
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
            ...
            <a href="{{ url('/event') }}" style="width: 100%; color: #fff;" class="blue_btn secondary-button hover-color">Access Our Organized Events Right Now</a>
        </div>
    </div>
