...
<body>
    <div class="banner-title-area service-page">
        ...
        <div class="sub-banner-content-flex service-banner" style="display: block; opacity: 1;">
            <h1 class="banner-text">Services 1</h1>
            <h2>Halal business & products promoting & selling</h2>
        </div>
        ...
        <div class="container w-container">
            <div data-w-id="a12d2fd6-7583-d887-bf84-3a054e05e56b" style="opacity: 0;"
                ...
                <div class="title-width service-page">
                    ...
                    <h2 class="section-title white">Halal business & products promoting & selling</h2>
                </div>
            </div>
                ...
                <div class="w-layout-grid service-grid">
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e57d-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Halal Certification and Compliance Consulting</h3>
                            <p class="white-content">
                                This service is the foundation for any Halal business. Halal Certification Bodies (HCBs) and consultants audit a company's ingredients, sourcing, production, processing, and logistics to ensure strict adherence to Islamic Shari'ah principles. They help businesses implement a robust Halal Assurance System (HAS) and issue the official certificate and logo, which is critical for consumer trust and market entry.
                            </p>
                        </div>
