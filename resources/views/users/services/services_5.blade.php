                ...
                <div class="w-layout-grid service-grid">
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e57d-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Primary Worship Facilities</h3>
                            <p class="white-content">
                                This is the core religious function. The project ensures the creation of a safe, spacious, and dedicated area (the prayer hall or musalla), complete with a Mihrab (niche indicating the direction of the Kaaba/Qibla) and necessary ablution (Wudu) facilities. This enables the five daily prayers (Salah), Friday congregational prayers (Jumu'ah), and Eid prayers.
                            </p>
                        </div>
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e58b-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Islamic Education & Learning</h3>
                            <p class="white-content">
                                Mosques are centers for knowledge. The project often includes the building of classrooms, a library, and study spaces (Maktabs or Madrasas). These facilities are essential for teaching children and adults the Holy Quran (including memorization and recitation/Tajweed) and fundamental Islamic knowledge (Fiqh and Hadith).
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e599-68652b7b"
                        ...
                        <div class="card-image-wrap"><img
                                ...
                                loading="lazy" width="76" alt="Home Page Card Image For Title"></div>
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Community & Social Hub</h3>
                            <p class="white-content">
                                The mosque acts as a central gathering place for the community. The project includes multi-purpose halls, event spaces, and meeting rooms for non-religious activities like community meetings, youth programs, marriage contracts (Nikah), and funeral preparations (Janazah). This fosters social cohesion and mutual support.
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
                    ...
                    <div id="w-node-a12d2fd6-7583-d887-bf84-3a054e05e5a7-68652b7b"
                        ...
                        <div class="service-card-content-wrap">
                            <h3 class="section-content-title white">Essential Social Services</h3>
                            <p class="white-content">
                                Many mosque projects integrate humanitarian and welfare services. This can involve setting up a Zakat/Sadaqah (charity) collection and distribution center, providing counseling/guidance for family or personal matters, and sometimes offering immediate humanitarian aid (e.g., food, water access, or temporary shelter) to the needy in the local area.
                            </p>
                        </div>
                        <div><a href="#" class="card-button w-inline-block"
                                style="color: rgb(171, 171, 172); background-color: rgba(0, 0, 0, 0); border-color: rgb(83, 83, 85);">
