...
<body>
    <div class="banner-title-area">
        ...
        <div class="sub-banner-content-flex" style="opacity: 1;">
            <h1 class="banner-text">My Profile Details</h1>
        </div>
...
" class="sub-banner-decorative-two">
    ...
    <div class="contact-section">
        <div class="container w-container">
            <div data-w-id="bb915454-e9f3-79b5-3dcb-b83cbaa7da28" style="opacity: 0;"
                ...
                <div class="title-width full-width">
                    <div class="section-sub-title center-align">
                        <p class="sub-title-content"><span class="sub-title-slash purple">//</span> 00 . Profile</p>
                    </div>
                    <h2 class="section-title">My Profile Info</h2>
                </div>
            </div>
    
            <div class="contact-card-wrap">
                <div class="w-layout-grid contact-card-grid">
                    <div id="w-node-b170416d-f63a-5fea-c10b-6653b1b910a8-7a942c15" data-w-id="b170416d-f63a-5fea-c10b-6653b1b910a8" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="contact-card">
                    ...
                    <div id="w-node-b86c9a41-6f18-d430-e956-f2441849a0d8-7a942c15" data-w-id="b86c9a41-6f18-d430-e956-f2441849a0d8" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="contact-card">
                        <div class="contact-inner-card">
                            <div class="card-title-wrap">
                                <div class="card-title">
                                    <div>PhoneNo</div>
                    ...
                    <div id="w-node-f5e6c974-1173-b519-d9ba-5f52611c6322-7a942c15" data-w-id="f5e6c974-1173-b519-d9ba-5f52611c6322" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="contact-card">
                        <div class="contact-inner-card">
                            <div class="card-title-wrap">
                                <div class="card-title">
                                    <div>Contact</div>
            ...
            <a href="{{ route('profile.edit') }}" class="blue_btn secondary-button hover-color">Edit Profile</a>
        </div>
    </div>
